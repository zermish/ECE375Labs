...
MAIN:							; The Main program
		; Setup the subtraction function

		; Subtract the 16-bit operands
		rcall	SUB16   ; Call the sub function
...
;-----------------------------------------------------------
SUB16:
		push XL; Save variable by pushing them to the stack
		push XH
		push YL
		push YH
		push A
		...
		mov mpr, XL
		add mpr, YL
		mov B, mpr //store low byte in r3 

		mov mpr, XH
		adc mpr, YH //should add the carry in there ....
		mov A, low(mpr) //store high byte in r4
